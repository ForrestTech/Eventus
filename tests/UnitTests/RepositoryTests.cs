namespace Eventus.UnitTests
{
    ...
    public class RepositoryTests
    {
        ...
        [Theory, AutoMoqData]
        public async Task Save_should_not_store_snapshot_if_aggregate_is_not_snapshotable([Frozen]Mock<IEventStorageProvider> eventStore,
            [Frozen]Mock<ISnapshotStorageProvider> snapshotProvider,
            Repository repo)
        {
            SetupNoExistingEvents(eventStore);
        ...
        [Theory, AutoMoqData]
        public async Task Save_should_not_check_snapshot_frequency_if_aggregate_is_not_snapshotable_([Frozen]Mock<IEventStorageProvider> eventStore,
            [Frozen]Mock<ISnapshotStorageProvider> snapshotProvider,
            Repository repo)
        {
            SetupNoExistingEvents(eventStore);
        ...
        [Theory, AutoMoqData]
        public async Task Save_should_store_snapshot_if_aggregate_is_snapshotable([Frozen]Mock<IEventStorageProvider> eventStore,
            [Frozen]Mock<ISnapshotStorageProvider> snapshotProvider,
            Repository repo)
        {
            SetupNoExistingEvents(eventStore);
        ...
        [Theory, AutoMoqData]
        public async Task Save_should_not_store_snapshot_if_changes_to_commit_greater_than_frequency([Frozen]Mock<IEventStorageProvider> eventStore,
            [Frozen]Mock<ISnapshotStorageProvider> snapshotProvider,
            Repository repo)
        {
            SetupNoExistingEvents(eventStore);
