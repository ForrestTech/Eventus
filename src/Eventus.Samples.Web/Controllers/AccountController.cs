...
using Eventus.Samples.Web.Models.AccountViewModels;
...
namespace Eventus.Samples.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            {
                await _emailSender.SendEmailAsync(await _userManager.GetEmailAsync(user).ConfigureAwait(false), "Security Code", message)
                    .ConfigureAwait(false);
            }
            else if (model.SelectedProvider == "Phone")
            {
                await _smsSender.SendSmsAsync(await _userManager.GetPhoneNumberAsync(user).ConfigureAwait(false), message)
                    .ConfigureAwait(false);
            }
