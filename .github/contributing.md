...
## Platform
Eventus is built against .net 4.6.2 with Visual Studio 2017. This is the only configuration we accept. (we are looking to move to .net standard)

## Bugs and feature requests?
Please log a new issue on Github:
...
1. Did you read the [documentation](https://feanz.github.io/Eventus/)?
